...
class Test_1_5_7 extends TestMetadata {
  constructor(metadata) {
    ...
    this.num = '1.5.7';
    this.description =
      "The request_object_encryption_alg_values_supported MUST be ['RSA-OAEP', 'RSA-OAEP-256']";
  ...
  async exec() {
    ...
    if (
      ...
      this.notes =
        'the claim request_object_encryption_alg_values_supported is not present';
      return true;
    }
    ...
    if (
      !(
        this.metadata.configuration
          .request_object_encryption_alg_values_supported.length == 2 &&
        this.metadata.configuration.request_object_encryption_alg_values_supported.includes(
          'RSA-OAEP'
        ) &&
        this.metadata.configuration.request_object_encryption_alg_values_supported.includes(
          'RSA-OAEP-256'
